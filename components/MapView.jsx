...
export default function MapView({ restaurants, isOpen, onClose, userLocation }) {
  ...
  const fetchNearby = useCallback(async (loc) => {
    ...
    try {
      const q = `[out:json][timeout:10];(node["amenity"~"restaurant|cafe|fast_food"](around:1000,${loc.lat},${loc.lng});way["amenity"~"restaurant|cafe|fast_food"](around:1000,${loc.lat},${loc.lng}););out center 15;`;
      ...
      const places = (data.elements || [])
        ...
        .map(el => ({
          ...
          address: el.tags['addr:street'] || '點擊查看地圖',
