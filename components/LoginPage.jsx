      ...
      `}>
        <div className="flex-1 flex flex-col justify-center space-y-10 py-8">
          ...
          <div className="text-center space-y-5 animate-bounce-in">
            <div
              className="w-16 h-16 bg-black rounded-[20px] mx-auto flex items-center justify-center shadow-[0_10px_25px_rgba(0,0,0,0.15)] transition-all duration-300 hover:scale-105 hover:shadow-[0_16px_36px_rgba(0,0,0,0.22)] active:scale-95 cursor-pointer">
              ...
              {loginStep === "idle" && (
                <form onSubmit={onGenerateCode} className="space-y-4 animate-fade-in">
                  <div className="relative flex items-center w-full group">
                    <span className="absolute left-5 top-1/2 -translate-y-1/2 text-base font-semibold text-[#86868B] group-focus-within:text-black select-none pointer-events-none transition-colors duration-200">@</span>
                    <input
                      type="text"
                  ...
                  <SlideButton type="submit" className="h-14 text-sm">
                    產生驗證碼
                  </SlideButton>
                </form>
              )}
                ...
                <form onSubmit={onVerifyCrawler} className="space-y-4 animate-fade-in">
                  <div className="rounded-2xl border border-black/10 bg-white/80 p-4 space-y-3">
                    ...
                    <div
                      ...
                      className="rounded-xl bg-black px-4 py-3 font-mono text-sm font-bold text-white text-center select-all tracking-wide cursor-copy transition-all duration-200 active:scale-[0.98] active:bg-neutral-800">
                  ...
                  <SlideButton type="submit" dark className="h-14 text-sm">
                    我已發文，驗證身分
                  </SlideButton>
