    ...
    <html lang="zh-TW">
      <head>
        ...
        <style>{`
          ...
          /* ── Tailwind CDN 沒有的 custom classes ── */
          .duration-380 { transition-duration: 380ms; }
          .active\:scale-\[0\.95\]:active { transform: scale(0.95) !important; }
          .active\:scale-\[0\.96\]:active { transform: scale(0.96) !important; }
          .active\:scale-\[0\.98\]:active { transform: scale(0.98) !important; }

          /* AppleButton — active scale 因為 CDN 不支援 active: variant on arbitrary values */
          button:active:not(:disabled) {
            transform: scale(0.95);
          }
          /* 但 LiquidGlassCard 的 div active 要另外處理 */
          [data-glass]:active {
