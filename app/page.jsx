...
import FoodRPG from '../components/FoodRPG';
              ...
              <div className="flex flex-col lg:flex-row lg:gap-8 lg:items-start">
                ...
                <aside ref={sidebarRef} className="hidden lg:flex flex-col gap-4 w-72 flex-shrink-0 sticky top-24">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <LiquidGlassCard onClick={() => setShowRPG(true)} className="py-4 text-sm font-bold text-[#E8821A] flex items-center justify-center gap-2 bg-[#E8821A]/10 border-[#E8821A]/25">
                      <span style={{fontSize:15}}>⚔️</span> 美食冒険録
                    </LiquidGlassCard>
                  </div>
