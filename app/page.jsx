              ...
              <div className="flex flex-col lg:flex-row lg:gap-8 lg:items-start">
                ...
                <aside ref={sidebarRef} className="hidden lg:flex flex-col gap-4 w-72 flex-shrink-0 sticky top-24">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <LiquidGlassCard onClick={() => setShowRPG(true)} className="py-4 text-sm font-bold text-[#1D1D1F] flex items-center justify-center gap-2 bg-white/30">
                      <span style={{fontSize:15}}>⚔️</span> 美食RPG
                    </LiquidGlassCard>
                  </div>
