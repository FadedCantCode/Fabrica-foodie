...
// --- 安全升級：優先從環境變數中動態讀取金鑰，避免敏感資料在 GitHub 被看光光 ---
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F2F7] text-[#1C1C1E] font-sans antialiased">
      ...
      {!isLoggedIn ? (
        /* ==================== iOS 風格登入頁面 (⚠️ 已完全移除了「Firebase 未啟用匿名驗證」的黃色警報) ==================== */
        ...
        <div className="pb-24">
                ...
                <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
                  {categories.map((cat) => (
                    <button
                      ...
                      className={`px-4.5 py-1.5 rounded-full text-xs font-bold whitespace-nowrap transition-all ${
          ...
          <footer className="text-center mt-12 mb-8 text-[11px] text-[#8E8E93] space-y-1">
            <p className="font-bold tracking-tight text-black">© Fabrica</p>
          </footer>
        </div>
      )}
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="space-y-3.5 text-xs">
              ...
              <div className="space-y-1.5">
                <label className="font-bold text-[#1C1C1E]">地址（選填 - 空白將自動以店名尋找定位）</label>
                <input 
                  type="text" 
